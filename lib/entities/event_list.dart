...
class EventList {
  static void Add(Map<int, Calendar> calendarMap,
      {Event? event, Map<String, dynamic>? input}) {
    if (event != null) {
  ...
  static void Delete(Map<int, Calendar> calendarMap,
  ...
  static Map<DateTime, List<DisplayEvent>> AsDisplay(
